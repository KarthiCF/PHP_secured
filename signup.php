  ...
  <body>
    ...
    <div class="container-sm py-4 px-5 ">
        ...
        <div class="p-1 container-sm">
            <form class="needs-validation mt-2 p-4"   style="max-width: 600px; margin: auto;" id="form" action="">

              <div class="mt-3">
                <!--First name-->
                <label class="signup-form-label " for="validationCustom01">First name</label>
                <input type="text" class="form-control" id="firstName" placeholder="First name" required>
              </div>
              
              <!--Last name-->
              <div class="mt-3">
                <label class="signup-form-label " for="validationCustom02">Last name</label>
              ...
              <!--username-->
              <div class="mt-3">
                <label class="signup-form-label " for="validationCustomUsername">Username</label>
              ...
              <!--Phone number-->
              <div class="mt-3">
                <label class="signup-form-label " for="validationCustom03">Phone</label>
                <input type="tel" class="form-control" id="phone" name="phone"  placeholder="91 1234567890" pattern="[0-9]{2} [0-9]{10}" required>
              </div>

              <!--email-->
              <div class="mt-3">
                <label class="signup-form-label " for="validationCustom03">Email address</label>
              ...
              <!--Password-->
              <div class="mt-3">
                <label class="signup-form-label " for="validationCustom04">Password</label>
              ...
              <!--Confirm password-->
              <div class="mt-3">
                <label class="signup-form-label " for="validationCustom05">Confirm password</label>
              ...
              <div class="form-group">
                <div class="form-check py-4">
                  ...
                  <label class="signup-form-label text-secondary " class="form-check-label" for="invalidCheck">
                ...
                <div class="text-center">
                    <button class="btn btn-danger text-center"  type="submit" id="signupButton" ><B>Signup</B></button>
